...
@game_blueprint.route('/patch/notes/<patch_version>/<champion_name>', methods=['GET'])
...
@game_blueprint.route('/patch/stats/<patch_version>', methods=['GET'])
...
@game_blueprint.route('/patch/stats/<patch_version>/<champion_name>', methods=['GET'])
